...
classdef StateEstimator_3 <matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime %#codegen
...
%                 Jrp_Origin2RToe = - Jp_RightToeJoint(q_pre);               
                ...
                if IRC.reset_IMU_KF || ~obj.initialized
                    obj.ITx_kf = zeros(3,1); % IT means IMU and Toe
                    obj.ITy_kf = zeros(3,1);
                    obj.ITz_kf = zeros(3,1);
                ...
                Cov_rp_LRToe = YToolkits.Angles.Rz(qyaw) * diag([obj.Cov_rpx_LRToe_body; obj.Cov_rpy_LRToe_body; obj.Cov_rpz_LRToe_body]) * YToolkits.Angles.Rz(qyaw)';
                if LegSwitch
                ...
                At = eye(3,3); At(2,1) = obj.sample_time;
...
%                 Rtx(1,1) = obj.Cov_LinearAccelerator(1)* obj.sample_time^2;
                Rtx(3,3) = SlideToeCovariance(obj,t,'x') * obj.sample_time^2;
...
%                 Rty(1,1) = obj.Cov_LinearAccelerator(2) * obj.sample_time^2;
                Rty(3,3) = SlideToeCovariance(obj,t,'y') * obj.sample_time^2;
...
%                 Rtz(1,1) = obj.Cov_LinearAccelerator(3) * obj.sample_time^2;
                Rtz(3,3) = SlideToeCovariance(obj,t,'z') * obj.sample_time^2;
